...
namespace Nadjia
{
    public partial class frmSetConfig : Form
    {
        ...
        private void frmSetConfig_Load(object sender, EventArgs e)
        {
        ...
        private void dbFolderSelector_Click(object sender, EventArgs e)
        {
        ...
        private void libraryFolderSelector_Click(object sender, EventArgs e)
        {
            DialogResult result = folderBrowserDialog1.ShowDialog();
            if (result == DialogResult.OK)
            {
        ...
        private void sweeperFolderSelector_Click(object sender, EventArgs e)
        {
            DialogResult result = folderBrowserDialog1.ShowDialog();
            if (result == DialogResult.OK)
            {
        ...
        private void dropsFolderSelector_Click(object sender, EventArgs e)
        {
            DialogResult result = folderBrowserDialog1.ShowDialog();
            if (result == DialogResult.OK)
            {
        ...
        private void advertFolderSelector_Click(object sender, EventArgs e)
        {
            DialogResult result = folderBrowserDialog1.ShowDialog();
            if (result == DialogResult.OK)
            {
        ...
        private void bumperFolderSelector_Click(object sender, EventArgs e)
        {
            DialogResult result = folderBrowserDialog1.ShowDialog();
            if (result == DialogResult.OK)
            {
        ...
        private void lrFolderSelector_Click(object sender, EventArgs e)
        {
            DialogResult result = folderBrowserDialog1.ShowDialog();
            if (result == DialogResult.OK)
            {
        ...
        private void soundboardFolderSelector_Click(object sender, EventArgs e)
        {
            DialogResult result = folderBrowserDialog1.ShowDialog();
            if (result == DialogResult.OK)
            {
